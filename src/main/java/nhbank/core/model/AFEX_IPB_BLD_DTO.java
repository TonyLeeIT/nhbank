...
public class AFEX_IPB_BLD_DTO {
    ...
    private BigDecimal MI_JAN;
    private BigDecimal LGB_BJAN;
    private BigDecimal LGB_FJAN;
    ...
    private BigDecimal DEPO_SEQ;
    private String INS_GAM_GB;
    private Date INS_IL;
    private BigDecimal INS_AMT;
