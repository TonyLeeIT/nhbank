...
public class ACOM_DTG_NAPAS_HIS_DTO {
    ...
    ON COLUMN
    FXVN.ACOM_DTG_NAPAS_HIS.DE014_EXP_;
    ...
    private Date COMMENT
    ON COLUMN
    FXVN.ACOM_DTG_NAPAS_HIS.DE015_STL_;
    private Date UPD_DT;
    ...
    private Date COMMENT
    ON COLUMN
    FXVN.ACOM_DTG_NAPAS_HIS.DE013_LOC_TRN_;
    ...
    private Date ADD
    CONSTRAINT ACOM_DTG_NAPAS_HIS_PK
    ...
    PRIMARY KEY(TRN_;
            ...
            private Date DE014_EXP_;
            private String DE051_BIL_CCY;
            private String DE013_LOC_TRN_DATE;
            private int COMMENT ON COLUMN FXVN.ACOM_DTG_NAPAS_HIS.HIS_NO IS'HISTORY;
            ...
            private Date COMMENT ON COLUMN FXVN.ACOM_DTG_NAPAS_HIS.TRN_;
