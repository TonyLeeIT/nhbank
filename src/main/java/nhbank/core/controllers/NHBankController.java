...
public class NHBankController {
    ...
    @GetMapping("/write")
    public ResponseEntity<ACOM_LMT_BASEHISInfo> writeToDB() {
        List<ACOM_LMT_BASEHISInfo> objList = GenerateUtils.assignObj();
//        service.updateTable(objList);
//        for(ACOM_LMT_BASEHISInfo obj : objList) {
//            service.insertTable(obj);
//        }
        service.insertTable(objList.get(0));
//        service.updateTable(objList);
        return new ResponseEntity<ACOM_LMT_BASEHISInfo>(HttpStatus.OK);
    }
